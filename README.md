...
### Script Writer (main workspace)
![Script Writer](public/assets/screenshots/script_writer.jpg)

### Inline Suggestions (git-diff style in editor)
...
- **Fresh thumbnail generation** (from scratch) + subversion generation
...
- **Script timing widget** + section outline
...
3. Choose the **text model**, **image analysis provider/model**, and **image generation provider/model**
